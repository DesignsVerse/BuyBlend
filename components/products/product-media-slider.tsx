...
export function ProductMediaSlider({ mediaItems, product }: { mediaItems: any[], product: any }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative h-130 w-full overflow-hidden rounded-lg bg-black mx-auto">
          ...
          {mediaItems.map((item, index) => (
            <button
              ...
              className={`relative aspect-square overflow-hidden rounded-lg cursor-pointer border-2 transition-all 
                ${activeIndex === index ? "border-gray-800" : "border-transparent hover:border-gray-400"}`}
            >
              {item._type === "image" ? (
                <Image
