...
function TestimonialCard({
  ...
  return (
    <motion.div
      ...
      className="min-w-[320px] max-w-[380px] bg-white rounded-xl p-6 sm:p-7 md:p-8 shadow-sm hover:shadow-md transition-shadow duration-300"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="overflow-hidden">
            ...
            >
              {shown.map((t) => (
                <div key={t.id} className="basis-[100%] sm:basis-[50%] mt-5 mb-5 lg:basis-[33.333%] shrink-0">
                  <TestimonialCard t={t} />
                </div>
              ))}
            </motion.div>
