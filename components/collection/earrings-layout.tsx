      ...
      <div className="container mx-auto px-2 py-4">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-10 gap-6">
          <div className="flex w-full items-center justify-between">
            ...
            {/* Mobile Controls (Filter Icon and Sort Dropdown) */}
            <div className="flex  items-center gap- lg:hidden">
              ...
              <div className="relative ">
                <select
                  ...
                  className="appearance-none bg-white border-2 border-black rounded-2xl pl-4 pr-12 py-3 text-sm  text-gray-900 font-medium shadow-sm"
                >
              ...
              >
                <div className="flex flex-col md:flex-row">
                  <div className="md:w-1/3 aspect-square relative">
                    {product.media &&
                    product.media[0] &&
                    product.media[0]._type === "image" ? (
                      <img
                        src={
                          product.media[0].asset
                            ? `https://cdn.sanity.io/images/your-project-id/production/${product.media[0].asset._ref.split("-")[1]}-${product.media[0].asset._ref.split("-")[2]}.${product.media[0].asset._ref.split(".")[1]}`
                            : "/placeholder.svg"
                        }
                        alt={product.name}
...
<div className="bg-[#FFF4F4] py-16 relative overflow-hidden">
  ...
  <div className="container mx-auto px-4 relative">
    <div className="max-w-4xl mx-auto text-center">
      <span className="inline-block px-4 py-1.5 bg-amber-100 text-amber-800 rounded-full text-sm font-semibold mb-4 border border-amber-200">
        🎉 Limited Time Special Offer
      </span>
      <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
        Get <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-orange-600">25% OFF</span> + Free Shipping
      </h2>
      <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
        Transform your space with premium products. Use code <code className="bg-gray-800 text-white px-2 py-1 rounded">WELCOME25</code> at checkout
      </p>
      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
        <button className="px-8 py-4 bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-xl font-bold text-lg hover:from-amber-700 hover:to-orange-700 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl">
          Shop Now & Save 25%
        </button>
        <button className="px-8 py-4 border-2 border-gray-800 text-gray-900 rounded-xl font-semibold text-lg hover:bg-gray-800 hover:text-white transition-all duration-300">
          View Best Sellers
        </button>
      </div>
      <p className="text-sm text-gray-500 mt-4">Offer ends in 2 days 14 hours</p>
    </div>
  </div>
</div>
    </div>
